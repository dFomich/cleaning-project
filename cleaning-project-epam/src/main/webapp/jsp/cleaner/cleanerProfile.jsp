...
<body leftmargin="50">
<c:set var="pagePath" scope="session" value="/jsp/cleaner/cleanerProfile.jsp"/>
<%@ include file="/jsp/static/header.jsp" %>
<div class="row">
    <div class="col">
        <form id="editClientProfile" method="post" action="${pageContext.request.contextPath}/controller">
            <input type="hidden" name="command" value="edit_cleaner_profile"/>
    ...
    <div class="col">
        <div>
            ...
            <form method="post" action="${pageContext.request.contextPath}/Upload" enctype="multipart/form-data">
                <fmt:message key="upload.legend"/> <input type="file" name="uploadFile"/>
                <br/><br/>
